...
const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  }), [theme, user, facultyList, page, isSidebarOpen, dashboardStats, refreshDashboardStats, isAiAvailable, showLogoutConfirm]);
...
const Sidebar: React.FC = () => {
    ...
    const superAdminNavLinks: (typeof navLinks[0])[] = [
      {
        title: 'System',
        links: [
